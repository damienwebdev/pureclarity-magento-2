 ...
 * Class Product
 *
 * Command class to run product feed via bin/magento pureclarity:runfeed:product
 */
class Product extends Command
{
    ...
    {
        $this->setName('pureclarity:runfeed:product')
             ->setDescription('Run Product Data Feed');
    ...
    public function execute(
        ...
        foreach ($this->storeManager->getStores() as $store) {
            $output->writeln('Running Product Feed for Store ID ' . $store->getId());
            $this->feedRunner->selectedFeeds($store->getId(), [Feed::FEED_TYPE_PRODUCT]);
        }

...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $prodFeedTable
            ...
            ->addColumn('product_id', Table::TYPE_TEXT, 255, [
                'nullable' => false
            ], 'Changed Product')
            ->addColumn('token', Table::TYPE_TEXT, 255, [
                'nullable' => true
            ], 'Token')
            ->addColumn('status_id', Table::TYPE_SMALLINT, null, [
                'nullable' => true
            ], 'Status')
            ->addColumn('message', Table::TYPE_TEXT, 255, [
                'nullable' => true
            ], 'Message')
            ->addIndex(

...
use Pureclarity\Core\Console\Command\RunFeed\Product;
 ...
 * Class ProductTest
 *
 * Tests methods in \Pureclarity\Core\Console\Command\RunFeed\Product
 * @see \Pureclarity\Core\Console\Command\RunFeed\Product
 */
class ProductTest extends TestCase
{
    ...
    public function testExecuteSingleStore(): void
    {
        ...
        $this->feedRunner->expects(self::once())->method('selectedFeeds')->with(1, [Feed::FEED_TYPE_PRODUCT]);
    ...
    public function testExecuteMultiStore(): void
    {
        ...
        $this->feedRunner->expects(self::at(1))->method('selectedFeeds')->with(17, [Feed::FEED_TYPE_PRODUCT]);
        $this->feedRunner->expects(self::at(2))->method('selectedFeeds')->with(42, [Feed::FEED_TYPE_PRODUCT]);
        $this->runExecute();
    }

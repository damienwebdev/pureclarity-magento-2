...
use Pureclarity\Core\Console\Command\RunFeed\OrderHistory;
 ...
 *
 * Tests methods in \Pureclarity\Core\Console\Command\RunFeed\OrderHistory
 * @see \Pureclarity\Core\Console\Command\RunFeed\OrderHistory
 */
class OrderHistoryTest extends TestCase
{
    /** @var OrderHistory $object */
    private $object;
    ...
    {
        self::assertInstanceOf(OrderHistory::class, $this->object);
    }
    ...
    public function testExecuteSingleStore(): void
    {
        ...
        $this->feedRunner->expects(self::once())->method('selectedFeeds')->with(1, [Feed::FEED_TYPE_ORDER]);
    ...
    public function testExecuteMultiStore(): void
    {
        ...
        $this->feedRunner->expects(self::at(0))->method('selectedFeeds')->with(1, [Feed::FEED_TYPE_ORDER]);
        $this->feedRunner->expects(self::at(1))->method('selectedFeeds')->with(17, [Feed::FEED_TYPE_ORDER]);
        $this->feedRunner->expects(self::at(2))->method('selectedFeeds')->with(42, [Feed::FEED_TYPE_ORDER]);
        $this->runExecute();
    }

...
use Pureclarity\Core\Console\Command\RunFeed\All;
 ...
 * Class AllTest
 *
 * Tests methods in \Pureclarity\Core\Console\Command\RunFeed\All
 * @see \Pureclarity\Core\Console\Command\RunFeed\All
 */
class AllTest extends TestCase
{
    ...
    {
        self::assertInstanceOf(All::class, $this->object);
    }
    ...
    public function testExecuteSingleStore(): void
    {
        ...
        $this->feedRunner->expects(self::at(0))->method('selectedFeeds')->with(1, [Feed::FEED_TYPE_PRODUCT]);
        $this->feedRunner->expects(self::at(1))->method('selectedFeeds')->with(1, [Feed::FEED_TYPE_CATEGORY]);
        $this->feedRunner->expects(self::at(2))->method('selectedFeeds')->with(1, [Feed::FEED_TYPE_BRAND]);
        $this->feedRunner->expects(self::at(3))->method('selectedFeeds')->with(1, [Feed::FEED_TYPE_USER]);
    ...
    public function testExecuteMultiStore(): void
    {
        ...
        $this->feedRunner->expects(self::at(2))->method('selectedFeeds')->with(1, [Feed::FEED_TYPE_BRAND]);
        $this->feedRunner->expects(self::at(3))->method('selectedFeeds')->with(1, [Feed::FEED_TYPE_USER]);
        $this->feedRunner->expects(self::at(4))->method('selectedFeeds')->with(17, [Feed::FEED_TYPE_PRODUCT]);
        $this->feedRunner->expects(self::at(5))->method('selectedFeeds')->with(17, [Feed::FEED_TYPE_CATEGORY]);
        $this->feedRunner->expects(self::at(6))->method('selectedFeeds')->with(17, [Feed::FEED_TYPE_BRAND]);
        $this->feedRunner->expects(self::at(7))->method('selectedFeeds')->with(17, [Feed::FEED_TYPE_USER]);
        $this->feedRunner->expects(self::at(8))->method('selectedFeeds')->with(42, [Feed::FEED_TYPE_PRODUCT]);
        $this->feedRunner->expects(self::at(9))->method('selectedFeeds')->with(42, [Feed::FEED_TYPE_CATEGORY]);
        $this->feedRunner->expects(self::at(10))->method('selectedFeeds')->with(42, [Feed::FEED_TYPE_BRAND]);
        $this->feedRunner->expects(self::at(11))->method('selectedFeeds')->with(42, [Feed::FEED_TYPE_USER]);
        $this->runExecute();
    }

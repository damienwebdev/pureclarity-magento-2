...
use Pureclarity\Core\Console\Command\RunFeed\Brand;
 ...
 * Class BrandTest
 *
 * Tests methods in \Pureclarity\Core\Console\Command\RunFeed\Brand
 * @see \Pureclarity\Core\Console\Command\RunFeed\Brand
 */
class BrandTest extends TestCase
{
    ...
    public function testExecuteSingleStore(): void
    {
        ...
        $this->feedRunner->expects(self::once())->method('selectedFeeds')->with(1, [Feed::FEED_TYPE_BRAND]);
    ...
    public function testExecuteMultiStore(): void
    {
        ...
        $this->feedRunner->expects(self::at(0))->method('selectedFeeds')->with(1, [Feed::FEED_TYPE_BRAND]);
        $this->feedRunner->expects(self::at(1))->method('selectedFeeds')->with(17, [Feed::FEED_TYPE_BRAND]);
        $this->feedRunner->expects(self::at(2))->method('selectedFeeds')->with(42, [Feed::FEED_TYPE_BRAND]);
        $this->runExecute();
    }

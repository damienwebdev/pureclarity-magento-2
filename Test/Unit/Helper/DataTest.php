...
class DataTest extends \PHPUnit\Framework\TestCase
{
     ...
     * returns false (as search now withdrawn), even if search is registered as being
     ...
     * still returns false (as search now withdrawn), even if product listing is registered as being
     * turned on within the configuration settings.
     * @dataProvider validStoreIdDataProvider
     */
     ...
     * returns false (as search now withdrawn), even if product listing is registered as being
     * turned on within the configuration settings.
     * @dataProvider validStoreIdDataProvider
     */
